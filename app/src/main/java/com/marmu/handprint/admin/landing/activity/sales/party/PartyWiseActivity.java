...
public class PartyWiseActivity extends AppCompatActivity {
        ...
        takenDBRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    //sp_route
                    ArrayAdapter<String> nameAdapter = new ArrayAdapter<>(PartyWiseActivity.this,
    ...
    public void generateSalesReport(View view) {
        ...
        if (!dte.isEmpty() && spinner.getSelectedItem() != null) {
            Intent productReport = new Intent(PartyWiseActivity.this, PartyReportActivity.class);
